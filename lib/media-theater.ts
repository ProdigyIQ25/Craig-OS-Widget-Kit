...
export type TheaterCapture={label:string;href:string};
...
export const mediaTheaterRegistry:Record<MediaTheaterMode,TheaterDefinition>={
  focus:{mode:"focus",label:"FOCUS",eyebrow:"SUPPORTING MEDIA",heading:"Focus Theater",description:"One objective remains primary. Media supports the work without taking over the room.",apiMode:"focus",emptyState:"No focus media is configured yet.",captures:[knowledgeCapture("+ Note"),knowledgeCapture("+ Insight")]},
