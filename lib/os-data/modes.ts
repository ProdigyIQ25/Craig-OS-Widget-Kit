...
export const personalModeRegistry: Record<PersonalMode, ModeDefinition<PersonalMode>> = {
  ...
  growth: { mode:"growth", label:"GROWTH", theme:"growth", heading:"Growth Lab", subheading:"Turn insight into practice.", primaryAction:{label:"Capture knowledge",href:notion.knowledge,primary:true,actionId:"A-P04"}, secondaryActions:[{label:"+ Insight",href:notion.knowledge,actionId:"A-P04"},{label:"Enter focus",href:"?mode=focus"}], mediaContext:media("learning","Learning media"), navigation:{label:"Growth Lab",href:notion.growth}, moduleOrder:["study","media","capture","frameworks","focus"], emptyState:"Knowledge detail stays protected until P08 read access is separately authorized." },
